...
class Finish_Capital_Help extends StatefulWidget {
  const Finish_Capital_Help({super.key});

  @override
  State<Finish_Capital_Help> createState() => _Finish_Capital_HelpState();
}

class _Finish_Capital_HelpState extends State<Finish_Capital_Help> {
  @override
